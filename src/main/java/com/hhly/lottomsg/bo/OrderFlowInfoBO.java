...
public class OrderFlowInfoBO extends BaseBO {
	...
	/**
	 * 1:等待支付, 2:支付成功(等待出票), 3:支付失败, 4:未支付过期, 5:出票中, 6:出票失败, 7:已撤单, 8:出票成功, 9:已中奖, 10:未中奖 
	 * 11:已派奖, 13:追号结束, 14:中奖追停, 15:追号撤单, 18:执行一期追号成功后, 19:执行一期追号失败后,
	 * 20:招募中, 21:合买未满员流产, 22:合买撤单流产
	 */
